  ...
  return {
    execute: (function () {
      ...
      */
      ...
      const registerServiceWorker = function registerServiceWorker(url) {
        let _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            scope = _ref.scope;
      ...
      const serviceWorkerUrl = new URL(System.resolve("./assets/service_worker.js", module.meta.url));
      ...
      const render = exports('render', () => {
        const logoUrl = new URL(System.resolve("./assets/logo.png", module.meta.url));
